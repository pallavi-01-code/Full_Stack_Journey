...
//upon clicking button for exchange rate logic
...
btn.addEventListener("click",(evt) => {
    //it will not be doing default action of form default
  evt.preventDefault();
  updateExchangeRate();
});

//first time when it loads it should display for auto default fields
